...
case 'baby-name-combiner': {
                            ...
                            const prompt = `
Can you generate 50 unique baby names by creatively combining the letters from the names of both parents "${name1}" and "${name2}"? For instance, if the father's name is Ankit and the mother's name is Priti, potential baby names could include Priank, Pritan, and others. The goal is to maximize the use of letters from both parents' names while allowing for the addition of a few extra letters to create meaningful and harmonious names. Please ensure that the names are diverse and reflect a variety of combinations, while still being easy to pronounce and appealing. 
